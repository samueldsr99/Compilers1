...
class NFA:
    ...
    def remove_state(self, state):
        # Remove transitions from and to this state
        ...
        for st, transitions in self.transitions.items():
            print('transitions of {}'.format(st), transitions)
            for _, nstates in transitions.items():
                print('nstates:', nstates, type(nstates))
                if state in nstates:
